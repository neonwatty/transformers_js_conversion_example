...
def main():
    ...
    if config.model_type == 'marian':
        ...
        if tokenizer is not None:
            from scripts.extra.vits import generate_tokenizer_json
            tokenizer_json = generate_tokenizer_json(tokenizer)
        ...
        if tokenizer is not None:
            from scripts.extra.speecht5 import generate_tokenizer_json
            tokenizer_json = generate_tokenizer_json(tokenizer)
        ...
        from scripts.extra.openelm import OpenElmOnnxConfig
    ...
    if not conv_args.split_modalities:
        ...
        if config.model_type == 'clip':
            ...
            from scripts.extra.clip import CLIPTextModelWithProjectionOnnxConfig, CLIPVisionModelWithProjectionOnnxConfig
            ...
            # Handle special case for exporting text and vision models separately
            from scripts.extra.siglip import SiglipTextModelOnnxConfig, SiglipVisionModelOnnxConfig
    ...
    if config.model_type == 'whisper':
        ...
        from scripts.extra.whisper import get_alignment_heads
